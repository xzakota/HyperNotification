...
object ShizukuManager {
    ...
    // 当 Shizuku 异常关闭或掉线时，通知 UI 层修改内存中 bypassFocusLimit 状态的回调
    ...
    private fun disableBypassFocusLimit() {
        try {
            Log.i(TAG, "检测到 Shizuku 服务离线，已自动回退关闭内存中的绕过选项")
